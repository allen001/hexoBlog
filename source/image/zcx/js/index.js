...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('#rectangle|#countdown 3|The Day is|#Date|The Time Is|#time|你是世界|世界是你|我愿用我心|好好的|陪你,爱你|赵春晓|I Love You|Best Wishes!|#author||');
    }
  ...
  function performAction(value) {
    ...
    timedAction(function (index) {
      ...
      switch (action) {
		...
		case 'author':
          S.Shape.switchShape(S.ShapeBuilder.letter('From Meng'));
          break;
        default:
          S.Shape.switchShape(S.ShapeBuilder.letter(current[0] === cmd ? 'Mcdull' : current));
      }
    }, 2800, sequence.length);
  }
